  ...
  return (
    <div className="flex items-center justify-center min-h-[100dvh] bg-cream-50">
      <div className="text-center">
        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-cream-100 flex items-center justify-center shadow-warm">
          <svg
            className="animate-spin h-8 w-8 text-sage-400"
