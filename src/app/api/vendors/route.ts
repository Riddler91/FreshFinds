...
// ── Seed mock data ─────────────────────────────────────────────────────
const MOCK_VENDORS = [
  { id: 1, businessName: "ATX Sourdough", lat: 30.2615, lng: -97.732, address: "1200 E 6th St, Austin, TX 78702", photoUrl: "https://images.unsplash.com/photo-1549931319-a545799f7b09?w=600&q=80", categoryName: "Bread & Pastries", categorySlug: "bread-pastries", categoryIcon: "🥖", rating: 4.7, reviewCount: 12, listingCount: 3, hasFreshItems: true, bio: "Hand-crafted sourdough bread using a 100-year-old starter. Baked fresh daily in East Austin.", verified: true, name: "Maria Rodriguez" },
  ...
  { id: 3, businessName: "Hill Country Honey", lat: 30.2477, lng: -97.9284, address: "8901 TX-71, Austin, TX 78735", photoUrl: "https://images.unsplash.com/photo-1471943311424-646960669fbc?w=600&q=80", categoryName: "Honey & Preserves", categorySlug: "honey-preserves", categoryIcon: "🍯", rating: 4.5, reviewCount: 5, listingCount: 3, hasFreshItems: false, bio: "Raw, unfiltered honey from our hives in the Texas Hill Country.", verified: false, name: "Robert Hill" },
  ...
  { id: 5, businessName: "Sunset Farms Produce", lat: 30.4015, lng: -97.7207, address: "11501 Rock Rose Ave, Austin, TX 78758", photoUrl: "https://images.unsplash.com/photo-1579113800032-c38bd7635818?w=600&q=80", categoryName: "Fresh Produce", categorySlug: "produce", categoryIcon: "🌽", rating: 4.6, reviewCount: 9, listingCount: 3, hasFreshItems: true, bio: "Family-run organic vegetable farm in North Austin. Seasonal produce grown without pesticides.", verified: true, name: "David & Sarah Martinez" },
  ...
  { id: 8, businessName: "Mama Lu's Kitchen", lat: 30.3340, lng: -97.7020, address: "8500 Research Blvd, Austin, TX 78758", photoUrl: "https://images.unsplash.com/photo-1576866209830-954e6bf8d5e2?w=600&q=80", categoryName: "Meals & Prepared", categorySlug: "meals", categoryIcon: "🍽️", rating: 4.9, reviewCount: 18, listingCount: 2, hasFreshItems: false, bio: "Homemade comfort food — lasagna, enchiladas, and meal prep boxes from a North Austin home kitchen.", verified: true, name: "Lucia Mendez" },
...
const MOCK_LISTINGS: Record<string, any[]> = {
  "1": [
    { id: 1, title: "Classic Country Loaf", description: "Our signature sourdough — tangy, chewy, with a crackling crust. 800g loaf.", price: 8.5, quantity: 6, photoUrl: "https://images.unsplash.com/photo-1549931319-a545799f7b09?w=600&q=80", dietaryTags: '["vegetarian","vegan"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Organic flour, water, sourdough starter, sea salt", allergenWarning: null, createdAt: new Date(Date.now() - 1800000).toISOString() },
    { id: 2, title: "Cinnamon Raisin Swirl", description: "Sourdough with organic cinnamon and plump California raisins.", price: 10.0, quantity: 4, photoUrl: "https://images.unsplash.com/photo-1509365465985-25d11c17e812?w=600&q=80", dietaryTags: '["vegetarian"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Organic flour, water, sourdough starter, cinnamon, raisins, sea salt", allergenWarning: null, createdAt: new Date(Date.now() - 3600000).toISOString() },
    { id: 3, title: "Everything Bagel Sourdough", description: "Limited batch — sourdough rolled in house-made everything seasoning.", price: 9.5, quantity: 3, photoUrl: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80", dietaryTags: '["vegetarian"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Organic flour, water, sourdough starter, sesame seeds, poppy seeds, garlic, onion, sea salt", allergenWarning: null, createdAt: new Date(Date.now() - 7200000).toISOString() },
  ],
  "2": [
    { id: 4, title: "Farm Fresh Dozen", description: "One dozen free-range eggs from pastured hens. Rich orange yolks.", price: 7.0, quantity: 20, photoUrl: "https://images.unsplash.com/photo-1598965675045-8e1e099edc5c?w=600&q=80", dietaryTags: '["vegetarian","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 900000).toISOString() },
    { id: 5, title: "Half Dozen + Herbs", description: "6 eggs plus a bundle of fresh kitchen herbs.", price: 6.0, quantity: 10, photoUrl: "https://images.unsplash.com/photo-1517686469429-8bdb88b9f907?w=600&q=80", dietaryTags: '["vegetarian","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 5400000).toISOString() },
  ],
  "3": [
    { id: 6, title: "Wildflower Honey — 16oz", description: "Raw, unfiltered wildflower honey from spring blooms.", price: 14.0, quantity: 15, photoUrl: "https://images.unsplash.com/photo-1471943311424-646960669fbc?w=600&q=80", dietaryTags: '["gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 86400000).toISOString() },
    { id: 7, title: "Mesquite Honey — 8oz", description: "Dark, bold honey from mesquite blossoms.", price: 10.0, quantity: 8, photoUrl: "https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&q=80", dietaryTags: '["gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 86400000).toISOString() },
    { id: 8, title: "Honeycomb Square", description: "A square of raw honeycomb — wax and honey together.", price: 8.0, quantity: 5, photoUrl: "https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&q=80", dietaryTags: '["gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 172800000).toISOString() },
  ],
  "4": [
    { id: 9, title: "Texas Pecan Pie", description: "Our blue-ribbon pecan pie with Texas pecans. 9-inch.", price: 28.0, quantity: 4, photoUrl: "https://images.unsplash.com/photo-1535920527002-b35e96722eb9?w=600&q=80", dietaryTags: '["vegetarian"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Pecans, eggs, butter, brown sugar, vanilla, flour, corn syrup", allergenWarning: "Contains nuts, eggs, dairy, wheat", createdAt: new Date(Date.now() - 1200000).toISOString() },
    { id: 10, title: "Seasonal Fruit Pie", description: "Summer peach and berry pie with a lattice top.", price: 26.0, quantity: 3, photoUrl: "https://images.unsplash.com/photo-1568571780765-9276ac2c48c9?w=600&q=80", dietaryTags: '["vegetarian"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Peaches, mixed berries, sugar, butter, flour, lemon juice", allergenWarning: "Contains dairy, wheat", createdAt: new Date(Date.now() - 4800000).toISOString() },
  ],
  "5": [
    { id: 11, title: "Weekly Veggie Box", description: "A curated box of seasonal organic vegetables.", price: 25.0, quantity: 10, photoUrl: "https://images.unsplash.com/photo-1579113800032-c38bd7635818?w=600&q=80", dietaryTags: '["vegan","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 600000).toISOString() },
    { id: 12, title: "Heirloom Tomato Basket", description: "5 lbs of mixed heirloom tomatoes.", price: 15.0, quantity: 8, photoUrl: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&q=80", dietaryTags: '["vegan","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 3000000).toISOString() },
  ],
  "6": [
    { id: 14, title: "Spring Bouquet", description: "A hand-tied bouquet of seasonal blooms from our farm.", price: 18.0, quantity: 5, photoUrl: "https://images.unsplash.com/photo-1561181286-d5ef733c1a54?w=600&q=80", dietaryTags: '[]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 1500000).toISOString() },
  ],
  "7": [
    { id: 15, title: "Migas Taco Plate", description: "3 migas tacos with chips and salsa — the Austin classic.", price: 9.5, quantity: 12, photoUrl: "https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=600&q=80", dietaryTags: '["vegetarian"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Eggs, tortilla chips, onion, jalapeño, cheese, salsa", allergenWarning: "Contains eggs, dairy", createdAt: new Date(Date.now() - 600000).toISOString() },
  ],
  "8": [
    { id: 16, title: "Family Lasagna", description: "A full tray of classic meat lasagna — feeds 6.", price: 32.0, quantity: 2, photoUrl: "https://images.unsplash.com/photo-1576866209830-954e6bf8d5e2?w=600&q=80", dietaryTags: '[]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Pasta, beef, ricotta, mozzarella, tomato sauce, herbs", allergenWarning: "Contains wheat, dairy, eggs", createdAt: new Date(Date.now() - 86400000).toISOString() },
  ],
  "9": [
    { id: 17, title: "Vegan Cupcake Box (6)", description: "Assorted vegan cupcakes — chocolate, vanilla, and red velvet.", price: 22.0, quantity: 4, photoUrl: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80", dietaryTags: '["vegan","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: "Almond flour, coconut oil, cane sugar, cocoa, vanilla", allergenWarning: "Contains nuts", createdAt: new Date(Date.now() - 2400000).toISOString() },
  ],
  "10": [
    { id: 18, title: "Microgreens Sampler", description: "3 trays of sunflower, pea shoots, and radish microgreens.", price: 15.0, quantity: 6, photoUrl: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=600&q=80", dietaryTags: '["vegan","gluten-free"]', pickupWindowStart: new Date(Date.now() + 86400000).toISOString(), pickupWindowEnd: new Date(Date.now() + 100800000).toISOString(), ingredients: null, allergenWarning: null, createdAt: new Date(Date.now() - 86400000).toISOString() },
  ],
};
